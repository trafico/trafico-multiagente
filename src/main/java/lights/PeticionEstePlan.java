...
public class PeticionEstePlan extends Plan {

	
	public PeticionEstePlan() {
	       // Initialization code.
	   ...
	   public void body() {
	       // Plan code.
			...
			int cnt = ((Integer)getBeliefbase().getBelief("estadoSemaforoEste").getFact()).intValue(); //Recupero el estado del semaro
