...
public class PeticionNortePlan extends Plan {

	
	public PeticionNortePlan() {
	       // Initialization code.
	   ...
	   public void body() {
	       // Plan code.
			...
			int cnt = ((Integer)getBeliefbase().getBelief("estadoSemaforoNorte").getFact()).intValue(); //Recupero el estado del semaro
