...
public class PeticionLineaNortePlan extends Plan {

	
	public PeticionLineaNortePlan() {
	       // Initialization code.
	   ...
	   public void body() {
	       // Plan code.
			...
			int cnt = ((Integer)getBeliefbase().getBelief("traficoLineaNorte").getFact()).intValue(); //Recupero el estado del semaro
