...
public class SetLineaPerpendicularPlan extends Plan {

	
	public SetLineaPerpendicularPlan() {
	       // Initialization code.
	   ...
	   public void body() {
	       // Plan code.
			...
			getBeliefbase().getBelief("traficoLineaPerpendicular").setFact(new Integer(valorNuevo));
