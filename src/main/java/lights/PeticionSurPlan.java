...
public class PeticionSurPlan extends Plan {

	
	public PeticionSurPlan() {
	       // Initialization code.
	   ...
	   public void body() {
	       // Plan code.
			...
			int cnt = ((Integer)getBeliefbase().getBelief("estadoSemaforoSur").getFact()).intValue(); //Recupero el estado del semaro
