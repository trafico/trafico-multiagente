...
public class PeticionLineaEstePlan extends Plan {

	
	public PeticionLineaEstePlan() {
	       // Initialization code.
	   ...
	   public void body() {
	       // Plan code.
			...
			int cnt = ((Integer)getBeliefbase().getBelief("traficoLineaEste").getFact()).intValue(); //Recupero el estado del semaro
